...
| 31 | Transparent pricing — customer vs airline price visibility | [Margin & Markups](https://duffel.com/docs/guides/margin-and-markups) — If a customer checks their booking reference on the airline website, they will see the price excluding our markup. Consider UX copy that frames our price as including "service fee" or "booking protection". | BACKLOG |
